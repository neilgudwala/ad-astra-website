...
const ATTRACTORS = [
    { 
      position: new THREE.Vector3(5, -1.3, 0),
...
export const ThreeAttractorsBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loader.load("public/atr1.jpg"),
    loader.load("/public/atr2.jpg"),
    loader.load("/public/atr3.jpg")
    ];
    ...
    for (let i = 0; i < count; i++) {
      ...
      masses[i] = 1e6 ; // Particle mass ~1e4
    ...
    ATTRACTORS.forEach((a, idx) => {
        ...
        const q = new THREE.Quaternion().setFromUnitVectors(new THREE.Vector3(0, 0, 1), a.axis.clone().normalize());
